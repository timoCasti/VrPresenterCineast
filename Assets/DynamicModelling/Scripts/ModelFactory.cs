...
namespace Unibas.DBIS.DynamicModelling
{
    public static class ModelFactory
    {
        ...
        ///     The wall's material name. Expects the material file to be at
        ///     Resources/Materials/materalName. If no present, the word Material will be suffixed.
        /// </param>
        /// <returns></returns>
        ...
        private static Material LoadMaterialByName(string materialName)
        {
            ...
            {
                if (!materialName.EndsWith("Material")) materialName = materialName + "Material";
