...
namespace DefaultNamespace
{
    public class TexturingUtility
    {
        ...
        {
            var material = name;
            if (translate) material = Translate(name);
            //else
            //{
            if (!material.EndsWith("Material")) material = material + "Material";
            ...
            if (!string.IsNullOrEmpty(material))
            {
                ...
                if (mat == null) Debug.LogWarning("Couldn't load material for name: " + material);
