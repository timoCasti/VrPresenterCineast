...
namespace Valve.VR.InteractionSystem
{
    ...
    public class TeleportPoint : TeleportMarkerBase
    {
        ...
        {
            if (!gotReleventComponents) return;
            ...
            else
            {
                ...
                switch (teleportType)
                {
                    ...
                    case TeleportPointType.SwitchToNewScene:
                    {
                        ...
                        break;
                    case TeleportPointType.MoveToPoint:
                    {
                        pointIcon = switchSceneIcon;
        ...
        public void GetRelevantComponents()
        {
            ...
            switchSceneIcon = transform.Find("teleport_marker_lookat_joint/teleport_marker_icons/switch_scenes_icon")
                .GetComponent<MeshRenderer>();
            moveLocationIcon = transform.Find("teleport_marker_lookat_joint/teleport_marker_icons/move_location_icon")
                .GetComponent<MeshRenderer>();
            lockedIcon = transform.Find("teleport_marker_lookat_joint/teleport_marker_icons/locked_icon")
                .GetComponent<MeshRenderer>();
            lookAtJointTransform = transform.Find("teleport_marker_lookat_joint");

            titleText = transform
                .Find("teleport_marker_lookat_joint/teleport_marker_canvas/teleport_marker_canvas_text")
                .GetComponent<Text>();
    ...
    public class TeleportPointEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                var teleportPoint = Selection.activeTransform.GetComponent<TeleportPoint>();
                if (GUI.changed) teleportPoint.UpdateVisualsInEditor();
            }
        }
    }
#endif
