...
namespace Valve.VR.InteractionSystem
{
    ...
    public class ItemPackageSpawner : MonoBehaviour
    {
        ...
        private void OnHandHoverBegin(Hand hand)
        {
            ...
            if (requireTriggerPressToTake && showTriggerHint) hand.ShowGrabHint("PickUp");
        }
        ...
        private void HandHoverUpdate(Hand hand)
        {
            ...
            {
                var startingGrab = hand.GetGrabStarting();

                if (startingGrab != GrabTypes.None) SpawnAndAttachObject(hand, startingGrab);
            }
        }
        ...
        {
            if (!justPickedUpItem && requireTriggerPressToTake && showTriggerHint) hand.HideGrabHint();
