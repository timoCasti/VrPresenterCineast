...
namespace Valve.VR.InteractionSystem
{
    public class SquishyToy : MonoBehaviour
    {
        ...
        [SteamVR_DefaultAction("Squeeze")] public SteamVR_Action_Single gripSqueeze;

        public Interactable interactable;

        [SteamVR_DefaultAction("Squeeze")] public SteamVR_Action_Single pinchSqueeze;
        ...
        private void Update()
        {
            ...
            renderer.SetBlendShapeWeight(0,
                Mathf.Lerp(renderer.GetBlendShapeWeight(0), grip * 150, Time.deltaTime * 10));

            if (renderer.sharedMesh.blendShapeCount > 1) // make sure there's a pinch blend shape
                renderer.SetBlendShapeWeight(1,
                    Mathf.Lerp(renderer.GetBlendShapeWeight(1), pinch * 200, Time.deltaTime * 10));
