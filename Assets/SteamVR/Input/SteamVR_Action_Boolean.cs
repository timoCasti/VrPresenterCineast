...
{
    /// <summary>
    ///     Boolean actions are either true or false. There is an onStateUp and onStateDown event for the rising and falling
    ///     edge.
    /// </summary>
    public class SteamVR_Action_Boolean : SteamVR_Action_In
    {
        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputDigitalActionData_t> actionData =
            new Dictionary<SteamVR_Input_Sources, InputDigitalActionData_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected uint actionData_size;

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputDigitalActionData_t> lastActionData =
            new Dictionary<SteamVR_Input_Sources, InputDigitalActionData_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Boolean>> onStateDown =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Boolean>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Boolean>> onStateUp =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Boolean>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected InputDigitalActionData_t tempActionData;
        ...
        public override void UpdateValue(SteamVR_Input_Sources inputSource)
        {
            ...
            var err = OpenVR.Input.GetDigitalActionData(handle, ref tempActionData, actionData_size,
                SteamVR_Input_Source.GetHandle(inputSource));
            if (err != EVRInputError.None)
                Debug.LogError("GetDigitalActionData error (" + fullPath + "): " + err + " handle: " + handle);
