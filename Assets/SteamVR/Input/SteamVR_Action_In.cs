...
namespace Valve.VR
{
    ...
    {
        [NonSerialized] protected static uint inputOriginInfo_size;

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, bool> active =
            new Dictionary<SteamVR_Input_Sources, bool>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, ulong> activeOrigin =
            new Dictionary<SteamVR_Input_Sources, ulong>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, bool> changed =
            new Dictionary<SteamVR_Input_Sources, bool>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, bool> lastActive =
            new Dictionary<SteamVR_Input_Sources, bool>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputOriginInfo_t> lastInputOriginInfo =
            new Dictionary<SteamVR_Input_Sources, InputOriginInfo_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, float> lastOriginGetFrame =
            new Dictionary<SteamVR_Input_Sources, float>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In, bool>> onActiveChange =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In, bool>>(
                new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In>> onChange =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In>> onUpdate =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_In>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, float> updateTime =
            new Dictionary<SteamVR_Input_Sources, float>(new SteamVR_Input_Sources_Comparer());
        ...
        /// <summary>
        ///     Gets the device index for the controller this action is bound to. This can be used for render models or the pose
        ///     tracking system.
        /// </summary>
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        ...
        protected void UpdateOriginTrackedDeviceInfo(SteamVR_Input_Sources inputSource)
        {
            ...
            {
                var inputOriginInfo = new InputOriginInfo_t();
                var err = OpenVR.Input.GetOriginTrackedDeviceInfo(activeOrigin[inputSource], ref inputOriginInfo,
                    inputOriginInfo_size);

                if (err != EVRInputError.None)
                    Debug.LogError("GetOriginTrackedDeviceInfo error (" + fullPath + "): " + err + " handle: " +
                                   handle + " activeOrigin: " + activeOrigin[inputSource] + " active: " +
                                   active[inputSource]);
        ...
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public void RemoveOnActiveChangeListener(Action<SteamVR_Action_In, bool> action,
