...
{
    /// <summary>
    ///     SteamVR_Behaviour_Single simplifies the use of single actions. It gives an event to subscribe to for when the
    ///     action has changed.
    /// </summary>
    public class SteamVR_Behaviour_Single : MonoBehaviour
    {
        ...
        {
            if (onChange != null) onChange.Invoke((SteamVR_Action_Single) action);
        }
    }
