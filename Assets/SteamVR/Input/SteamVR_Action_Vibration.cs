...
namespace Valve.VR
{
    ...
    public class SteamVR_Action_Vibration : SteamVR_Action_Out
    {
        ...
        ///     The device you would like to execute the haptic action. Any if the action is not device
        ///     specific.
        /// </param>
            ...
            SteamVR_Input_Sources inputSource)
        {
            ...
            var err = OpenVR.Input.TriggerHapticVibrationAction(handle, secondsFromNow, durationSeconds, frequency,
                amplitude, SteamVR_Input_Source.GetHandle(inputSource));
            ...
            if (err != EVRInputError.None)
                Debug.LogError("TriggerHapticVibrationAction (" + fullPath + ") error: " + err + " handle: " + handle);
        }
    }
}