...
{
    /// <summary>
    ///     Vector2 actions are useful when you need two analog values from the same device. Radial menu navigation or
    ///     character controllers are good examples of this.
    /// </summary>
    public class SteamVR_Action_Vector2 : SteamVR_Action_In
    {
        ...
        public override void UpdateValue(SteamVR_Input_Sources inputSource)
        {
            ...
            if (err != EVRInputError.None)
                Debug.LogError("GetAnalogActionData error (" + fullPath + "): " + err + " handle: " + handle);
