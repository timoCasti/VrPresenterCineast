...
namespace Valve.VR
{
    ...
    ///     SteamVR also keeps a log of past poses so you can retrieve old poses with GetPoseAtTimeOffset or
    ///     GetVelocitiesAtTimeOffset.
    ///     You can also pass in times in the future to these methods for SteamVR's best prediction of where the pose will be
    ///     at that time.
    /// </summary>
    public class SteamVR_Action_Pose : SteamVR_Action_In
    {
        ...
        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputPoseActionData_t> lastPoseActionData =
            new Dictionary<SteamVR_Input_Sources, InputPoseActionData_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, bool> lastRecordedActive =
            new Dictionary<SteamVR_Input_Sources, bool>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputPoseActionData_t> lastRecordedPoseActionData =
            new Dictionary<SteamVR_Input_Sources, InputPoseActionData_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized]
        protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>> onDeviceConnectedChanged =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>> onTrackingChanged =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>> onValidPoseChanged =
            new Dictionary<SteamVR_Input_Sources, Action<SteamVR_Action_Pose>>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected Dictionary<SteamVR_Input_Sources, InputPoseActionData_t> poseActionData =
            new Dictionary<SteamVR_Input_Sources, InputPoseActionData_t>(new SteamVR_Input_Sources_Comparer());

        [NonSerialized] protected uint poseActionData_size;

        [NonSerialized] public float predictedSecondsFromNow = 0;

        [NonSerialized] protected InputPoseActionData_t tempPoseActionData;
        ...
        public virtual void UpdateValue(SteamVR_Input_Sources inputSource, bool skipStateAndEventUpdates)
        {
            ...
            if (skipStateAndEventUpdates == false) ResetLastStates(inputSource);

            var err = OpenVR.Input.GetPoseActionData(handle, universeOrigin, predictedSecondsFromNow,
                ref tempPoseActionData, poseActionData_size, SteamVR_Input_Source.GetHandle(inputSource));
            if (err != EVRInputError.None)
                Debug.LogError("GetPoseActionData error (" + fullPath + "): " + err + " handle: " + handle);
            ...
            else if (Mathf.Abs(Quaternion.Angle(GetLocalRotation(inputSource), GetLastLocalRotation(inputSource))) >
                     changeTolerance) changed[inputSource] = true;

            if (skipStateAndEventUpdates == false) CheckAndSendEvents(inputSource);
        ...
        /// <summary>
        ///     SteamVR keeps a log of past poses so you can retrieve old poses or estimated poses in the future by passing in a
        ///     secondsFromNow value that is negative or positive.
        /// </summary>
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        ...
        {
            var err = OpenVR.Input.GetPoseActionData(handle, universeOrigin, secondsFromNow, ref tempPoseActionData,
                poseActionData_size, SteamVR_Input_Source.GetHandle(inputSource));
            if (err != EVRInputError.None)
            {
                Debug.LogError("GetPoseActionData error (" + fullPath + "): " + err + " handle: " +
                               handle); //todo: this should be an error
            ...
            velocity = new Vector3(tempPoseActionData.pose.vVelocity.v0, tempPoseActionData.pose.vVelocity.v1,
                -tempPoseActionData.pose.vVelocity.v2);
            angularVelocity = new Vector3(-tempPoseActionData.pose.vAngularVelocity.v0,
                -tempPoseActionData.pose.vAngularVelocity.v1, tempPoseActionData.pose.vAngularVelocity.v2);
        ...
        /// </summary>
        /// <param name="inputSource">The device you would like to get data from. Any if the action is not device specific.</param>
        public bool GetPoseAtTimeOffset(SteamVR_Input_Sources inputSource, float secondsFromNow, out Vector3 position,
            out Quaternion rotation, out Vector3 velocity, out Vector3 angularVelocity)
        {
            var err = OpenVR.Input.GetPoseActionData(handle, universeOrigin, secondsFromNow, ref tempPoseActionData,
                poseActionData_size, SteamVR_Input_Source.GetHandle(inputSource));
            if (err != EVRInputError.None)
        ...
        {
            if (poseActionData[inputSource].pose.eTrackingResult !=
                lastPoseActionData[inputSource].pose.eTrackingResult && onTrackingChanged[inputSource] != null)
                onTrackingChanged[inputSource].Invoke(this);

            if (poseActionData[inputSource].pose.bPoseIsValid != lastPoseActionData[inputSource].pose.bPoseIsValid &&
                onValidPoseChanged[inputSource] != null)
                onValidPoseChanged[inputSource].Invoke(this);

            if (poseActionData[inputSource].pose.bDeviceIsConnected !=
                lastPoseActionData[inputSource].pose.bDeviceIsConnected &&
                onDeviceConnectedChanged[inputSource] != null)
        ...
        {
            return new Vector3(poseActionData[inputSource].pose.vVelocity.v0,
                poseActionData[inputSource].pose.vVelocity.v1, -poseActionData[inputSource].pose.vVelocity.v2);
        }
        ...
        {
            return new Vector3(-poseActionData[inputSource].pose.vAngularVelocity.v0,
                -poseActionData[inputSource].pose.vAngularVelocity.v1,
                poseActionData[inputSource].pose.vAngularVelocity.v2);
        }
        ...
        {
            return new Vector3(lastPoseActionData[inputSource].pose.vVelocity.v0,
                lastPoseActionData[inputSource].pose.vVelocity.v1, -lastPoseActionData[inputSource].pose.vVelocity.v2);
        }
        ...
        {
            return new Vector3(-lastPoseActionData[inputSource].pose.vAngularVelocity.v0,
                -lastPoseActionData[inputSource].pose.vAngularVelocity.v1,
                lastPoseActionData[inputSource].pose.vAngularVelocity.v2);
        }
        ...
        /// <param name="action">
        ///     The method you would like to be called when a device is connected. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
        ...
        /// <param name="action">
        ///     The method you would like to stop calling when a device is connected. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
        public void RemoveOnDeviceConnectedChanged(SteamVR_Input_Sources inputSource,
            Action<SteamVR_Action_Pose> action)
        {
            onDeviceConnectedChanged[inputSource] -= action;
        }
        ...
        /// <param name="inputSource">The device you would like to add an event to. Any if the action is not device specific.</param>
        /// <param name="action">
        ///     The method you would like to be called when tracking has changed. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
        ...
        /// <param name="inputSource">The device you would like to remove an event from. Any if the action is not device specific.</param>
        /// <param name="action">
        ///     The method you would like to stop calling when tracking has changed. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
        ...
        /// <param name="inputSource">The device you would like to add an event to. Any if the action is not device specific.</param>
        /// <param name="action">
        ///     The method you would like to be called when the pose has become valid or invalid. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
        ...
        /// <param name="inputSource">The device you would like to remove an event from. Any if the action is not device specific.</param>
        /// <param name="action">
        ///     The method you would like to stop calling when the pose has become valid or invalid. Should take a
        ///     SteamVR_Action_Pose as a param
        /// </param>
