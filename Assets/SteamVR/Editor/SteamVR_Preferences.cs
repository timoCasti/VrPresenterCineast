...
namespace Valve.VR
{
    public class SteamVR_Preferences
    {
        ...
        public static bool AutoEnableVR
        {
            ...
            set { EditorPrefs.SetBool("SteamVR_AutoEnableVR", value); }
        }
        ...
        private static void PreferencesGUI()
        {
            ...
            {
                var title = "Automatically Enable VR";
                var tooltip = "Should SteamVR automatically enable VR on launch and play?";
                AutoEnableVR = EditorGUILayout.Toggle(new GUIContent(title, tooltip), AutoEnableVR);
                var helpMessage = "To enable VR manually:\n";
